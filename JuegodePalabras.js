...
let arrayPalabras =["SMS", "CAPACITAR", "QR", "DOCE", "CUATRO", "PELIGRO"];
//Arreglo que contiene las ayudas de cada palabra
let ayudas = [
    "Es un Sistema Para Identificar Peligros",
    "Es un compromiso de las Politicas de SMS",
    "Es la Herramienta Para Identificar Peligros",
    "Cuantos Elementos tiene el SMS",
    "Cuantos Componentes tiene el SMS",
    "Tiene El Potencial de Hacer Daños y Lesiones a Personas"
]
...
function cargarNuevaPalabra(){
    ...
    if(cantPalabrasJugadas>6){
        ...
        arrayPalabras =["SMS", "CAPACITAR", "QR", "DOCE", "CUATRO", "PELIGRO"];
        ayudas = [
            "Es un Sistema Para Identificar Peligros",
            "Es un compromiso de las Politicas de SMS",
            "Es la Herramienta Para Identificar Peligros",
